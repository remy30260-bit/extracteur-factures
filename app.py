...
.page-header { margin-bottom: 1.5rem; padding-bottom: 1rem; border-bottom: 1px solid #ece9e4; }
.page-header h1 { font-size: 1.5rem; font-weight: 800; color: #1a1a2e; margin: 0 0 0.25rem 0; }
.page-header p { color: #6b7280; font-size: 0.84rem; margin: 0; }
.panel { background: white; border-radius: 14px; border: 1px solid #ece9e4; overflow: hidden; margin-bottom: 1rem; }
.panel-header { padding: 0.9rem 1.2rem; border-bottom: 1px solid #f7f5f3; display: flex; align-items: center; justify-content: space-between; }
.panel-title { font-size: 0.88rem; font-weight: 700; color: #1a1a2e; }
.panel-body { padding: 1rem 1.2rem; }
.kpi-grid { display: grid; grid-template-columns: repeat(4, 1fr); gap: 1rem; margin-bottom: 1.5rem; }
.kpi-card { background: white; border-radius: 14px; border: 1px solid #ece9e4; padding: 1.2rem 1.5rem; transition: box-shadow 0.2s; }
...
.invoice-table th { padding: 0.6rem 0.8rem; text-align: left; color: #9ca3af; font-weight: 600; font-size: 0.72rem; text-transform: uppercase; letter-spacing: 0.05em; border-bottom: 1px solid #f3f4f6; }
.invoice-table td { padding: 0.7rem 0.8rem; border-bottom: 1px solid #f9f8f7; color: #374151; }
.invoice-table tr:last-child td { border-bottom: none; }
.invoice-table tr:hover td { background: #fafaf9; }
.form-panel { background: white; border-radius: 14px; border: 1px solid #ece9e4; padding: 1.5rem; margin-bottom: 1rem; }
.form-section-title { font-size: 0.82rem; font-weight: 700; color: #9ca3af; text-transform: uppercase; letter-spacing: 0.08em; margin-bottom: 1rem; }
.upload-zone { background: white; border-radius: 14px; border: 2px dashed #e5e0d8; padding: 3rem 2rem; text-align: center; margin-top: 1rem; }
</style>
""", unsafe_allow_html=True)
...
# 3. Boutons Streamlit cliquables (UN SEUL bloc)
